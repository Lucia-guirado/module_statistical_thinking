...
En las siguientes figuras se muestran boxplots que representan la distribución de precios de las viviendas en función de la presencia o ausencia de ciertas amenities clave. Cada caja representa la distribución de precios para viviendas que cuentan con la amenidad (Sí) y aquellas que no la tienen (No). 
...
En este caso la diferencia de precio medio entre viviendas con TV (69€ la noche) y sin TV (35€ la noche) es significativa, por lo que la instalación de una TV en la vivienda puede ser una buena estrategia para optimizar el precio medio del alojamiento.
...
Analizando los datos de amenities se puede oservar que aquellas como que la vivienda incluya TV, aire acondicionado, calefaccion o cocina tienen un precio medio mayor que aquellas viviendas que no las incluyen. Sin embargo, la instalación de Wifi no tiene gran impacto en el precio, por lo que la instalación de wifi no deberia de ser prioritaria a la hora de aumentar el precio de un alojamiento.
...
En la siguiente figura se ve reflejado el número de habtaciones (entre 1 y 3 habitaciones) y su relación con el precio medio del alojamiento. Cada caja representa la distribución de precios para cada número de habitaciones que contenga la vivienda, incluyendo mediana, cuartiles y posibles outliers.
...
En la figura se observa que la mediana de los precios aumenta significativamente al pasar de 1 a 2 habitaciones (de 60€ a 75€ la noche). Sin embargo, al aumentar de 2 a 3 habitaciones, el incremento en la mediana del precio es mucho menor (de 75€ a 80€ la noche). Por lo tanto, se puede deducir que el número óptimo de habitaciones, en este rango, es de 2, de manera que se maxima el precio medio del alojamiento.
...
En la siguiente figura se ve reflejado el número mínimo de noches (entre 1 y 7 noches) y su relación con el precio medio del alojamiento. Cada caja representa la distribución de precios para cada número mínimo de noches, incluyendo mediana, cuartiles y posibles outliers.
...
En la siguiente figura se ve reflejado los distintos tipos de políticas de cancelación y su relación con el precio medio del alojamiento. Cada caja representa la distribución de precios para cada tipo de política de cancelación, incluyendo mediana, cuartiles y posibles outliers.
...
### **Amenities** 
Priorizar la instalación de una TV, aire acondicionado, cocina completa y calefacción en propiedades nuevas. El WiFi no es diferenciador.
...
En las viviendas que se disponga de una sola habitación, es altamente recomendado invertir en la creación de una segunda habitación, ya que esto incrementa significativamente el precio medio del alojamiento. Sin embargo, si la vivienda ya cuenta con dos habitaciones, añadir una tercera no supone un gran aumento en el precio medio, por lo que se debe evaluar cuidadosamente la rentabilidad de dicha inversión.
